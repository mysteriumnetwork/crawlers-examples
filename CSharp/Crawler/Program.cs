...
namespace Crawler
{
    ...
    class Crawler
    {
        ...
        const int maxHosts = 5;

        // maxHostsConstraint returns true if we have to skip the given link
        private bool maxHostsConstraint(string e)
        {
            var uri = new Uri(e);           
